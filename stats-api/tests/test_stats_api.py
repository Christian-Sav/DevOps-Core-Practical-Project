...
class TestViews(TestBase):
    def test_tags(self):
        ...
        self.assert200(response)
        self.assertIn(b'{"barter":20,"energy_weapons":20,"explosives":20,"guns":5,"lockpick":5,"medicine":5,"melee_weapons":5,"repair":5,"science":5,"sneak":5,"speech":5,"survival":5,"trait_1":"Heavy_Handed","trait_2":"Hot_Blooded","unarmed":5}\n', response.data)
